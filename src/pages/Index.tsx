  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-electric/5 rounded-full blur-3xl animate-float" style={{ animationDelay: "3s" }} />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
